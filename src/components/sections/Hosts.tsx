...
import { hosts, hostsCta, hostsHeader } from "@/lib/content";
...
function HostCard({ name, role, image }: HostCardProps) {
  return (
    <article
...
export function Hosts() {
  return (
    <section id="hosts" className="relative overflow-hidden bg-[#1D1413] text-white">
      <div
        ...
        <MotionSection>
          <div className="mx-auto max-w-[620px] text-center">
            <h2 className="font-display whitespace-pre-line text-[38px] leading-[46px] text-white sm:text-5xl sm:leading-[57.6px]">
              {hostsHeader.title.replace(" Make ", " Make\n")}
            </h2>
            <Image
              src={images.hostUnderline}
              alt=""
